...
let a =10;
console.log(2 || (a = 20));  // 2, since first value is truthy, next expression is not even evaluated
console.log('a', a);    // and hence value of a remains 10

console.log('h' || 10) ;  //h, since string 'h' is truthy value
console.log('' || 10);    // 10, since empty string '' is falsy value, so the out put is 10
...
// null coalsene(??) will only return next value if the previous vale is null or undefined
let h = 0;
console.log(h ?? 10); //0
