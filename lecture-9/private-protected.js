class CoffeeMachine {
    ...
    brewCoffee() {
        console.log('Brewing coffee with', this.power);
    }
    brewCoffee() {
...
machine.waterAmount = -100;  //that is not possible because value is negative
machine.brewCoffee();

machine.power = 50;   //can't change the value of power, because it is read only
